<div class="hidden w-28 bg-indigo-700 overflow-y-auto md:block">
  <div class="w-full py-6 flex flex-col items-center">
    ...
    <div class="flex-1 mt-6 w-full px-2 space-y-1">
      ...
      <a href="/artists" 
      class="{{Route::currentRouteName() == 'Artists' ? 'bg-indigo-800 text-white' : 'text-indigo-100 hover:bg-indigo-800 hover:text-white'}} group w-full p-3 rounded-md flex flex-col items-center text-xs font-medium" aria-current="page">
