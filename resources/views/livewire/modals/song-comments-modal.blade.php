    ...
    <div class="relative">
      ...
      <div class="absolute bottom-0 inset-x-0 pl-3 pr-2 py-2 flex justify-between">
        ...
        <div class="flex-shrink-0">
          <button type="submit" wire:click="createComment" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Post</button>
        </div>
      </div>
    </div>
  </div>
